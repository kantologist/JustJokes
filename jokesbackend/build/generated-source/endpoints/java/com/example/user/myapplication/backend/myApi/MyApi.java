...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class MyEndpoint {
    ...
    /**
     * Create a request for the method "myEndpoint.fetchJoke".
     *
    ...
    public class FetchJoke extends MyApiRequest<com.example.user.myapplication.backend.myApi.model.JokeModel> {
       ...
       */
      protected FetchJoke() {
        super(MyApi.this, "POST", REST_PATH, null, com.example.user.myapplication.backend.myApi.model.JokeModel.class);
      }
